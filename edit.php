...
<html lang="pl">
	...
	<body>
		...
		<main id="main">
			<?php
				$entry=$connection->query(sprintf("SELECT Subject,Content FROM blog WHERE ID=$ID"));
			...
			?>
			<form action="edit_q.php" method="POST">
					Tytuł notatki: <input type="text" name="Subject" <?php echo"value='$S'" ?>><br><br>
					Treść notatki: <br><textarea name="Content" rows="100" cols="100"><?php echo "$C"?></textarea><br><br>
					<input type="hidden" value="<?php echo "$ID"?>" name="ID">
					<input type="submit" value="Zmień notatkę">
				</form>
		</main>
		<aside id="right">
			<?php
