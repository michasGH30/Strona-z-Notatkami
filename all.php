	...
	<body>
		...
		<main id="main">
			...
			<article>
				<div id="entries">
					<?php 
						$entries=$connection->query(sprintf("SELECT ID,Subject,Date_Add FROM blog ORDER BY Date_Add DESC"));
						...
						while($entry = $entries->fetch_assoc())
						{
							...
							echo "<a href='entry.php?ID=$ID' class='entry_link'> <b>Tytuł:</b> <i>".$entry['Subject']."</i> <b>Data Dodania:</b> <i>".$date."</i></a>";
							if(isset($_SESSION['logged']) && $_SESSION['logged']==true)
							{
								echo " <a href='edit.php?ID=$ID' class='entry_link'>Edytuj</a>";
							}
							echo "<br>";
						}
						$entries->free();
